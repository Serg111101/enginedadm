...
export function Satellites() {
  ...
  async function deleteItem(name: string, index: number, id: number) {
    await axios.delete(
        ...
        >
                ...
                <div className="editBlock">
                  ...
                  {done && <>
                    <div className="editbutton1" >
                      <DeleteOutlined className="iconantd" onClick={() => { deleteItem("text1", i, Satellites.id); }} />
          ...
          <div className="editbutton1">
            {!upload && Satellites?.animationCubeSat1 && done && (
              <DeleteOutlined className="iconantd" onClick={() => { deleteItem("animationCubeSat1", 0, Satellites.id); }} />
            )}
            {!upload && done && (
                ...
                (<>
                  ...
                  <div className="editBlock">
                    ...
                    <DeleteOutlined
                        className="iconantd"
                        onClick={() => {
                          deleteItem("text2", i, Satellites.id);
                        }}
                      />
                  ...
                  <div className="editBlock">
                    ...
                    ( {done &&
                      <div className="editbutton1">
                         <DeleteOutlined
                          onClick={() => {
                            deleteItem("margin_text1", i, Satellites.id);
                          }}
                          className="iconantd"
                        />
              ...
              {!upload && done && added === '' && (
                <div className="editbutton1">
                  <DeleteOutlined
                    className="iconantd"
                    onClick={() => {
                      deleteItem("animationCubeSat2", 0, Satellites.id);
                    }}
                  />
...
<DeleteOutlined
                        className="iconantd"
                        onClick={() => {
                          deleteItem("text3", i, Satellites.id);
                        }}
                      />
                ...
                <div className="editBlock">
                  ...
                  {Satellites.margin_text2 && done && (
                    <div className="editbutton1" >
                        ...
                        className="iconantd"
                        onClick={() => {
                          deleteItem("margin_text2", i, Satellites.id);
                        }}
                      />
              ...
              {edit[0] === "text4" && done && edit[1] === i ? (
                ...
                <div className="editBlock">
                  ...
                  <DeleteOutlined
                      className="iconantd"
                      onClick={() => {
                        deleteItem("text4", i, Satellites.id);
                      }}
                    />
                  ...
                  <p className="margin_text">{el}</p>
                  {
                      ...
                      <div
                        className="editbutton1">
                          ...
                          className="iconantd"
                          onClick={() => {
                            deleteItem("margin_text3", i, Satellites.id);
                          }}
                        />
          ...
          {!upload && done && added === '' && (
            <div className="editbutton1">
              <DeleteOutlined
                className="iconantd"
                onClick={() => {
                  deleteItem("animationCubeSat3", 0, Satellites.id);
                }}
              />
                ...
                <div className="editBlock">
                  ...
                  {done && <> <div
                    className="editbutton1">
                      ...
                      className="iconantd"
                      onClick={() => {
                        deleteItem("text5", i, Satellites.id);
                      }}
                    />
              ...
              {done && !upload && Satellites.animationCubeSat4 && (
                <div className="editbutton1" >
                  <DeleteOutlined
                    className="iconantd"
                    onClick={() => {
                      deleteItem("animationCubeSat4", 0, Satellites.id);
                    }}
                  />
                ...
                <div className="editBlock">
                  ...
                  {done && <> <div
                    className="editbutton1">
                      ...
                      className="iconantd"
                      onClick={() => {
                        deleteItem("margin_text4", i, Satellites.id);
                      }}
                    />
